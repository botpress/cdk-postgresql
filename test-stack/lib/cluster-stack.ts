...
export class ClusterStack extends Stack {
  ...
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    publicCluster.connections.allowFromAnyIpv4(ec2.Port.allTraffic(), 'Open to the world')

    const privateClusterSecurityGroup = new ec2.SecurityGroup(this, 'privateClusterSecurityGroup', { vpc })
