...
export const dbExists = async (client: Client, db: string): Promise<boolean> => {
...
export const createSecret = async (secretsManager: SecretsManager, secretStr: string): Promise<string> => {
...
export const getDbOwner = async (client: Client, db: string): Promise<string> => {
